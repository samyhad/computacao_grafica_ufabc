...
class MyApp(ShowBase):
    ...
    def __init__(self):
        ...
        model = self.loader.load_model('../3dmesh/orchid-flower/source/Orchid_highpoly/Orchid_Highpoly.obj')
        ...
        texture = self.loader.load_texture('../3dmesh/orchid-flower/source/Orchid_highpoly/Orchid_Highpoly.jpg')
